  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-semibold">Общий обзор</h1>
          <p className="text-sm text-zinc-500 mt-1">Ключевые цифры EYWA SPACE за сегодня.</p>
        </div>
        <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg" style={{ background: 'var(--muted)', border: '1px solid var(--card-border)' }}>
          ...
          <select className="bg-transparent text-sm border-0 focus:outline-none" style={{ border: 'none' }}>
