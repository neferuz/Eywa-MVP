...
import { ArrowLeft, Phone, AtSign, User2, Share2, ExternalLink, Calendar, CreditCard, AlertTriangle, StickyNote, Instagram, MessageCircle, UsersRound, Globe } from "lucide-react";
...
export default async function ClientDetailPage({ params }: PageProps) {
  ...
  const client: Client | null = (await fetchClientByIdFromApi<Client>(id)) ?? getClientById(id) ?? null;
  if (!client) {
    return (
